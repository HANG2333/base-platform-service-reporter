...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    private static final String FUZZY_QUERY_PARAM = "%";
    private static final String SUBSTITUTE_PARAM = "@@";


    /**
     * method_name:checkFuzzyQuery
     * create_user:ZNW
     * create_date:2020/9/8
     * create_time:14:49
     * describe:是否包含模糊查字符
     * param:[str]
     * return:boolean
     */
	public static String checkFuzzyQuery(String str){
		if(StringUtils.isNotEmpty(str)){
			if(str.contains(FUZZY_QUERY_PARAM)){
				str = str.replaceAll(FUZZY_QUERY_PARAM,SUBSTITUTE_PARAM);
			}
			return  str;
		}
		return  null;
